				...
				$.ajax({
					...
					success:function(data){
						...
						$.each(rows,function(n,value){
							...
							if(n<rows.length-1)
								outClass="classDesc";
							valueStr += "<div  class='"+outClass+"'><h3><a target='_blank'  href='ViewQuestion.jsp?id="+value.questionId+"'>"+value.title+"</a></h3>"+
...
<!--	<div class="ui-widget">
	...
	<div class="mainContent search">
		<div class="rightContent">
			<input type="hidden" value="wd" id="search_type" NAME="search_type">
			<div  id="searchTab"  class="searchType">
				<ul>
					...
					<li id="searchTab_Title8" class="on" onclick="searchTabs('searchTab',this);document.getElementById('search_type').value='wd';"><a href='javascript:void(0)'>问答</a></li>
