...
<script>
	...
	function loadTeachers(page){
		$.ajax({
			url:"struts/TeacherInfo_getNXTeacherList?page="+page+"&rows=10",
			success:function(data){
				...
				$.each(rows,function(n,value){
					valueStr += "<div class='teacherList'><ul >"+
								...
								"<table>"+
								"<tr><td colspan='2'><h3 class='th3'><a href='teacherClass.jsp?type=2&id="+value.teacherId+"'>"+value.realName+"</a></h3></td></tr>"+
