...
<head>
	...
	<script>
		$(function() {
			if("<%= keyw%>"!="null"){
				$.ajax({
					url:"struts/Search_queryDownloadBySolr?page=1&rows=10&key="+"<%=keyw%>",
 ...
 -->
	...
	<div class="mainContent search">
		<div class="rightContent">
			<input type="hidden" value="xz" id="search_type" NAME="search_type">
			<div  id="searchTab"  class="searchType">
				<ul>
					...
					<li id="searchTab_Title5" class="on" onclick="searchTabs('searchTab',this);document.getElementById('search_type').value='xz';"><a href='javascript:void(0)'>下载</a></li>
