...
<head>
	...
	<script>
		$(function() {
			if("<%= keyw%>"!="null"){
				$.ajax({
					url:"struts/Search_queryInnerCourseBySolrWithSubject?page=1&rows=10&key="+"<%=keyw%>",
					success:function(data){
						...
						if(valueStr == ""){
							valueStr = "<div class='notice'>未搜索到相关内训信息</div>";
						}else
...
function search(page){
	...
	$.ajax({
		url:"struts/Search_queryInnerCourseBySolrWithSubject?page="+page+"&rows=10&key="+key,
		success:function(data){
			var jsonObject = eval('('+data+')');
			var valueStr = "";
			var pages = jsonObject.pages;
		...
		<div class="rightContent">
			...
			<div  id="searchTab"  class="searchType">
				<ul>
					...
					<li id="searchTab_Title6" onclick="searchTabs('searchTab',this);document.getElementById('search_type').value='wk';"><a href='javascript:void(0)'>文库</a></li>
