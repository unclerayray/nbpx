...
<div class="mainContent partTwo" style="margin-top:0px;padding-top:0px">
		...
		<li class="noneStyle">
			<div class="part left" >
				<div class="head">
					...
					<div class="tabOn">财务</div>
					<div class="tabOff">物流</div>
					<div class="tabOff">人力</div>
					<div class="tabOff">生产</div>
					<div class="tabOff">营销</div>
				<div class="clear"></div>
			</div>
				<div class="bg h245">
	...
	<li class="noneStyle">
		...
		<ul>
			<li class="noneStyle">
				<div class="part left">
					<div class="head">
						<div class="tabOn"><a href="#">财务管理高端课程</a></div>	
						<div class="tabOff">学员推荐</div>
						<div class="tabOff">培训师推荐</div>
						<div class="clear"></div>
					</div>
					<div class="bg h245">
						<div style="padding-left:25px;padding-top:10px">
		...
		<div class="part left">
					<div class="head">
						<div class="tabOn"><a href="#">物流供应链高端课程</a></div>
						<div class="tabOff">学员推荐</div>
						<div class="tabOff">培训师推荐</div>
						<div class="clear"></div>
					</div>
		...
		<li class="noneStyle">
				<div class="part left">
					<div class="head">
						<div class="tabOn"><a href="#">人力资源高端课程</a></div>	
						<div class="tabOff">学员推荐</div>
						<div class="tabOff">培训师推荐</div>
						<div class="clear"></div>
					</div>
		...
		<div class="part left">
					<div class="head">
						<div class="tabOn"><a href="#">生产管理高端课程</a></div>
						<div class="tabOff">学员推荐</div>
						<div class="tabOff">培训师推荐</div>
						<div class="clear"></div>
					</div>
		...
		<li class="noneStyle">
			<div class="part left">
				<div class="head">
					<div class="tabOn"><a href="#">营销客服高端课程</a></div>	
					<div class="tabOff">学员推荐</div>
					<div class="tabOff">培训师推荐</div>
					<div class="clear"></div>
				</div>
	...
	<div class="part left">
				<div class="head">
					<div class="tabOn"><a href="#">综合战略高端课程</a></div>
					<div class="tabOff">学员推荐</div>
					<div class="tabOff">培训师推荐</div>
					<div class="clear"></div>
				</div>
	...
	<!--月份 start-->
		<div class="head">2012年企业培训日历</div>
		<div class="bg p5 h40">
			<ul class="list2">
				<li><a href="#">01月</a></li>
				<li><a href="#">02月</a></li>
		...
		<!--内训 start-->
		<div class="head">2013年企业培训日历</div>
		<div class="bg p5 h40" >
				<ul class="list2">
					<li><a href="#">01月</a></li>
					<li><a href="#">02月</a></li>
