...
<script>
	...
	function loadTeachers(page){
		$.ajax({
			url:"struts/OrgInfo_getOrgList?page="+page+"&rows=10",
			success:function(data){
				...
				$.each(rows,function(n,value){
					valueStr += "<div class='teacherList'><ul >"+
								...
								"<table>"+
								"<tr><td colspan='2'><h3 class='th3'><a href='orgView.jsp?id="+value.orgId+"'>"+value.orgName+"</a></h3></td></tr>"+
								"<tr><td width='60px' align='right'>联系人:</td><td align='left' width='200px'>"+(value.contact == undefined?"暂无介绍":value.contact)+"</td><td width='60px'>公司网址:</td><td align='left'>"+value.website+"</td></tr>"+
								"<tr><td>机构地址:</td><td colspan='3'  align='left'>"+value.address+"</td></tr>"+
								"<tr><td>机构简介:</td><td colspan='3' align='left'>"+(value.introduction == undefined?"暂无介绍":value.introduction)+"</td></tr>"+
								"</table>"+
								"</div>"+
								"</li>"+
								"</ul>"+
		...
		<!--  <div class="teacherList">
			...
			<li>
				<div style="width:550px;padding-top:10px">
					...
					<tr><td width="60px">擅长领域:</td><td align='left' width="200px">xxxx</td><td width="60px">公司网址:</td><td>wwww.baidu.com</td></tr>
					<tr><td>机构地址:</td><td colspan='3'  align='left'>哈哈哈啊哈</td></tr>
					<tr><td>个人简介:</td><td colspan='3'  align='left'>哈哈哈啊哈</td></tr>
					</table>
				</div>
			</li>
			</ul>
