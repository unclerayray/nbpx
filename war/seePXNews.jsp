...
<script>
	...
	function getNews(page){
		...
		$.ajax({
			url:"struts/LiveScene_queryLiveScene?flag=1&page="+page+"&rows=30" ,
			success:function(data){
				...
				$.each(rows,function(n,value){
					valueStr += "<li style='border-bottom:1px dashed #ccc;width:95%'>"+value.title+"<span></span></li>";
				});

				if(valueStr == ""){
					valueStr = "<div class='notice'>未搜索到相关培训动态信息</div>";
				}
