...
<script>
	...
	function getDownLoads(page){
		...
		$.ajax({
			url:"struts/LiveScene_queryTuozhan?page="+page+"&rows=30" ,
			success:function(data){
				//alert(data);
				var jsonObject = eval('('+data+')');
				var valueStr = "";
				...
				$.each(rows,function(n,value){
					valueStr += "<li style='border-bottom:1px dashed #ccc;width:95%'>"+value.title+"<span><a href='viewTuoZhan.jsp?id="+value.liveSceneId+"'>查看</a></span></li>";
				});
